...
public abstract class WizardPopup extends AbstractPopup implements ActionListener, ElementFilter {
  ...
  protected boolean exclusiveKeyEventProcessingByRegisteredActions = false;
  ...
  public void setExclusiveKeyEventProcessingByRegisteredActions(boolean exclusiveKeyEventProcessingByRegisteredActions) {
    this.exclusiveKeyEventProcessingByRegisteredActions = exclusiveKeyEventProcessingByRegisteredActions;
  }
  ...
  public final boolean dispatch(KeyEvent event) {
    ...
    if (event.getID() == KeyEvent.KEY_PRESSED) {
      ...
      if (consumed) {
        return exclusiveKeyEventProcessingByRegisteredActions;
      }
    }
