 ...
 */
public class RebuildProjectRepeatedlyAction extends CompileActionBase {
  ...
  public void update(AnActionEvent event) {
    ...
    if (rebuild) {
      presentation.setText("Stop Rebuilding");
    }
    else {
      presentation.setText("Rebuild Project Repeatedly");
    }
  }
